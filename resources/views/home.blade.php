        ...
        <div class="banner-carousel owl-theme owl-carousel">
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content">
                        <h5>Fueling The Future</h5>
                        <div class="border-box"></div>
                        <h2>An Oil Company<br> <span>That Works</span></h2>
                        <div class="btns-box">
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content">
                        <h5>Delivering technology solutions</h5>
                        <div class="border-box"></div>
                        <h2>We make IT <br> <span>simple, faster, and less expensive</span></h2>
                        <div class="btns-box">
                            <a class="btn-one thm-bgc1" href="#"><span class="txt">Learn More</span></a>
                        </div>
                    </div>
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content">
                        <h5>Welcome to the evolution</h5>
                        <div class="border-box"></div>
                        <h2>Make communications<br> <span>make a difference</span></h2>
                        <div class="btns-box">
                            <a class="btn-one thm-bgc1" href="#"><span class="txt">Learn More</span></a>
                        </div>
                    </div>
                ...
                <div class="facts-box wow animated fadeInUp" data-wow-delay="0.5s">
                    <ul>
                        <li>
                            ...
                            <div class="title"><h3>Fast Delivery</h3></div>
                        </li>
                        <li>
                            <div class="icon"><span class="flaticon-popular thm-clr1"></span></div>
                            <div class="title"><h3>5K Customers</h3></div>
                        </li>
                        <li>
                            <div class="icon"><span class="flaticon-loan-1 thm-clr1"></span></div>
                            <div class="title"><h3>Certified Engineers </h3></div>
                        </li>
                        <li>
                            <div class="icon"><span class="flaticon-insurance-1 thm-clr1"></span></div>
                            <div class="title"><h3>Value for money</h3></div>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="theme-carousel service-carousel owl-carousel owl-theme owl-dot-style1" data-options='{"loop":true, "margin":30, "autoheight":true, "nav":false, "dots":true, "autoplay":true, "autoplayTimeout":10000, "smartSpeed":700, "responsive":{ "0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "3"}, "1199":{"items": "4" }}}'>
                    ...
                    <div class="single-service-style1">
                        ...
                        <h3>Oil and gas product supply, storage and distribution</h3>
                        <div class="text">
                    ...
                    <div class="single-service-style1">
                        ...
                        <h3>Information, Communication and Technology
                        </h3>
                    ...
                    <div class="single-service-style1">
                        <div class="icon">
                            <span class="flaticon-loan-2"></span>
                        </div>
                        <h3>Supply of Office Furniture & Fittings
                    ...
                    <div class="single-service-style1">
                        ...
                        <h3>Provision of Primary Energy and Renewable Energy
                        </h3>
...
<!--Start Calculate Loan area-->

<!--End Calculate Loan area-->
...
<section class="latest-project-area">
    ...
    <div class="outer-container">
        <div class="theme-carousel project-carousel owl-carousel owl-theme owl-dot-style2" data-options='{"loop":true, "margin":30, "autoheight":true, "nav":false, "dots":true, "autoplay":true, "autoplayTimeout":10000, "smartSpeed":700, "responsive":{ "0":{"items": "1"}, "768":{"items": "2"}, "1199":{"items": "3" }}}'>
                            ...
                            <div class="box">
                                <div class="content">
                                    <div class="zoom-button">
                                        <a class="lightbox-image" data-fancybox="gallery" href="assets/images/project/project-v1-1.jpg">
                    ...
                    <div class="inner">
                        ...
                        <div class="overlay-style-one bg1">
                            <div class="box">
                                <div class="content">
                                    <div class="zoom-button">
                                        <a class="lightbox-image" data-fancybox="gallery" href="assets/images/project/project-v1-2.jpg">
                                            <img src="assets/images/icon/zoom.png" alt="Zoom Icon">
                                        </a>
                                    </div>
                                </div>
...
<section class="testimonial-style1-area">
    <div class="layer-outer" style="background-image:url(assets/images/pattern/testimonial-bg.png);"></div>
    <div class="container">
        <div class="sec-title">
            <div class="title">
            ...
            <div class="big-title"><h2>What about Say <span>Our Clients</span></h2></div>
        </div>
        <div class="row">
            <div class="col-xl-12">
...
<section class="latest-blog-area ">
    <div class="container">
            ...
            <div class="col-xl-12">
                <div class="top">
                    <div class="sec-title">
                        ...
                        <div class="big-title"><h2>Our Recent <span>Insights</span></h2></div>
                    </div>
                    <div class="button">
        ...
        <div class="row d-none">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="single-blog-post wow fadeInUp animated" data-wow-delay="0.1s" data-wow-duration="1200ms">
                    ...
                    <div class="text-holder">
                        ...
                        <h3 class="blog-title"><a href="blog-single.html">How to Reduce Your Home<br> Loan Rate</a></h3>
                        <div class="read-more">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="single-blog-post wow fadeInUp animated" data-wow-delay="0.3s" data-wow-duration="1200ms">
                    ...
                    <div class="text-holder">
                        ...
                        <h3 class="blog-title"><a href="blog-single.html">Grow Business & Changing<br> Faster and Better</a></h3>
                        <div class="read-more">
                            <a href="blog-single.html">READ MORE<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
            ...
            <!--Start single blog post-->
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="single-blog-post wow fadeInUp animated" data-wow-delay="0.5s" data-wow-duration="1200ms">
                    <div class="img-holder">
                        <div class="inner">
                    ...
                    <div class="text-holder">
                        ...
                        <h3 class="blog-title"><a href="blog-single.html">Plan for the Future and For<br> Your Life Now</a></h3>
                        <div class="read-more">
                            <a href="blog-single.html">READ MORE<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
